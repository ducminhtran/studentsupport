...
import com.meowbeos.studentsupport.activity.document.DocumentFileFragment;
...
public class DocumentCategoryAdapter extends RecyclerView.Adapter<DocumentCategoryAdapter.ViewHolder> {
    ...
    public DocumentCategoryAdapter(Context context, List<Document> documents) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DocumentFileFragment fragment = new DocumentFileFragment();
